...
Konventsiya: `data` qatlami exception tashlaydi → `repository` uni ushlab `Failure`ga aylantiradi → `domain`/`presentation` qatlami faqat `Failure` bilan ishlaydi. Batafsil: [`docs/architecture.md`](../../docs/architecture.md).
