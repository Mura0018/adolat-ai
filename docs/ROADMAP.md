...
- **Rolga asoslangan navigatsiya skeletini o'rnatish** — `docs/UI.md`, "Navigation Structure" bo'limidagi uchta navigatsiya tuzilmasi (Fuqaro/Tashkilot, Admin) bo'sh/skeleton ekranlar bilan bo'lsa-da, auth guard orqali ishlaydigan holga keltirish.
